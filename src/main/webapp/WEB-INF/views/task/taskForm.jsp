...
<body>
	<form id="inputForm" action="${ctx}/api/v1/task" method="post" class="form-horizontal">
		...
		<fieldset>
			...
			<div class="form-actions">
                <input id="ajax_btn" class="btn btn-primary" type="button" value="AJAX提交"/>&nbsp;
                <input id="submit_btn" class="btn btn-primary" type="submit" value="表单提交"/>&nbsp;
